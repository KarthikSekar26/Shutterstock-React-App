...
import MyPresentationalComponent from './source/MyPresentationalComponent'
...
export default class AwesomeProject extends Component {
   constructor() {
    ...
    componentWillMount() { 
    return fetch('https://api.shutterstock.com/v2/images/search?per_page=200&query=random&view=full'
      ,{
      headers: {
